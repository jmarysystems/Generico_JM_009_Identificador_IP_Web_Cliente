...
import identificador_ip_web_cliente_menu_e_submenu.Identificador_Ip_Web_Cliente_Menu_01;
import identificador_ip_web_cliente_menu_e_submenu.Identificador_Ip_Web_Cliente_Submenu_01;
 
/** 
 *
 * @author NewUser
 */
public class Identificador_Ip_Web_Cliente_00_Main extends JApplet {
    ...
    public void init() {
        ...
        Home.adicionar_Menu(new Identificador_Ip_Web_Cliente_Menu_01( Home ).Barra_Menu );
        Home.adicionar_SubMenu(new Identificador_Ip_Web_Cliente_Submenu_01( Home ) );
    ...
    public static void main(String[] args) {
        ...
        JApplet applet = new Identificador_Ip_Web_Cliente_00_Main();
        applet.init();
